...
export const BOARD_THEMES = [
  ...
  {
    /* Acessibilidade: máximo contraste entre casas e fundo neutro */
    nome: 'ALTO CONTRASTE',
    light: 0xF7F7F7, dark: 0x202020, frame: 0x000000,
    bg: 0x0A0A0A, table: 0x141414,
    fogColor: 0x0A0A0A, fogNear: 18, fogFar: 48,
    weather: 'none'
  }
];
...
export const PIECE_THEMES = [
  ...
  /* Acessibilidade: amarelo x azul — seguro para daltonismo vermelho-verde (deutan/protan) */
  { nome: 'DALTÔNICO (AMARELO×AZUL)', p1: 0xFFD400, p2: 0x0066FF, n1: 'AMARELAS', n2: 'AZUIS', shape: 'standard', mat: 'phong' }
];
